...
# # Contents
#
# - [ ] R server GUI - barebones info is there
# - [ ] R package install
...
# SSH config files {background-color="#0a4e62"}
...
# Remote SSH {background-color="#0a4e62"}
...
# Hopping between login and compute nodes {background-color="#0a4e62"}
...
# Running GUI tools on CalcUA {background-color="#0a4e62"}
...
# Persistent SSH sessions {background-color="#0a4e62"}
...
# Pretty `squeue` {background-color="#0a4e62"}
...
# Transferring files {background-color="#0a4e62"}
...
# Too many small files or large volumes of data {background-color="#0a4e62"}
...
# Best practices for file permissions {background-color="#0a4e62"}
...
# HPC container wrapper as a `conda`/`mamba` alternative {background-color="#0a4e62"}
...
# A note on R, RStudio Projects and `renv` {background-color="#0a4e62"}
...
# Nextflow on CalcUA {background-color="#0a4e62"}
