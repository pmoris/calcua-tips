...
By default, VSCode will store all the components it needs + a cache in your home directory. Due to the limited quota, you should change this location to the data partition.
...
If you ever notice a long latency between executing a command and regaining a prompt, even for lightweight commands, this might be happening. Don't let it happen to you.
:::
...
### (and a little tip regarding dotfiles)
...
::: aside
([check out HackerNews for many more opinions on the matter](https://news.ycombinator.com/item?id=41453264)).
:::
...
::: {.callout-tip}
In many cases, testing your code on a representive small test dataset is the better approach, but for things like deciding on clustering or QC thresholds, this might not be feasible.
:::
...
I won't go into much detail here, but this is what you probably should be using whenever it is feasible (i.e. collaborators also have acccess to it).
...
- [https://pythonspeed.com/articles/conda-dependency-management/](https://pythonspeed.com/articles/conda-dependency-management/)
- [https://openscpca.readthedocs.io/en/stable/ensuring-repro/managing-software/using-conda/](https://openscpca.readthedocs.io/en/stable/ensuring-repro/managing-software/using-conda/)
...
# A note on R and `renv` {background-color="#0a4e62"}
...
<!-- TODO add VSC R project info + Renviron -->
