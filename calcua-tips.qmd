...
::: {.callout-tip}
If you prefer, you can set another `.Renviron` option to force `renv` to install packages to a shared directory (e.g. in `/data`) instead of inside your (`/scratch`) project directory:
